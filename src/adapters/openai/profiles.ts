...
export const EDIT_PROFILE_INSTRUCTIONS = [
  ...
  "Obey any supplied GROUNDING REQUIREMENTS context block exactly.",
  "For each proposed change, reasoningProposal.claims must include the requiredSupportingClaimKind claim that cites that target's requiredEvidenceReference, and supportingClaimIds must include that claim's claimId.",
  "Do not invent evidence handles. Do not substitute a different claim kind for the requiredSupportingClaimKind.",
  "All references and target identifiers must come from the supplied task and context data only.",
